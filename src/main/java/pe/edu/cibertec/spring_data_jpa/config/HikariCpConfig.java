package pe.edu.cibertec.spring_data_jpa.config;
...
public class HikariCpConfig {
    ...
    public HikariDataSource hikariDataSource() {
         ...
         * - IdleTimeout: Tiempo máximo de espera para eliminar una conexión inactiva.
         * - ConnectionTimeout: Tiempo máximo de espera para conectarse a la BD.
         */
